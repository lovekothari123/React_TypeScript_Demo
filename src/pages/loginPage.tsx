...
import {HeadingTxt} from '../untility/String';
...
const LoginPageInner = (props: Props) => {
  ...
  const onLogin = () => {
    if (isValidLogin(loginInfo)) {
      ...
      props.history.push({pathname:"/pageB", state: loginInfo.login});
    } else {
  ...
  return (
    <>
      ...
      <NotificationComponent
        message="Invalid Name, please type again"
